...
/**
 * \brief Exchange basic thread registers.
 ...
 * operations and to force the thread to raise an artificial exception (see \a
 * flags).
 *
 */
 ...
 * \ingroup l4_thread_api
 *
 * \brief API for Thread Control method.
 *
 *
...
/**
 * \brief Start a thread control API sequence.
...
/**
 * \brief Set the exception handler.
 * \ingroup l4_thread_control_api
 *
...
/**
 * \brief Enable pass through of native host (Linux) system calls.
 * \ingroup l4_thread_control_api
 * \param   on    Boolean value defining the state of the feature.
 *
...
/**
 * \brief Yield current time slice.
 * \ingroup l4_thread_api
 *
 * \return system call return tag
 */
...
/**
 * \brief Switch to another thread (and donate the remaining time slice).
 * \ingroup l4_thread_api
 *
...
/**
 * \brief Start a thread sender modifiction sequence.
 * \ingroup l4_thread_api
 *
...
/**
 * \brief Operations on thread objects.
 * \ingroup l4_thread_api
 * \hideinitializer
 * \internal
 */
...
/**
 * \brief Flags for the thread control operation.
 * \ingroup l4_thread_api
 * \hideinitializer
 * \internal
 *
...
/**
 * \brief Indices for the values in the message register for thread control.
 * \ingroup l4_thread_api
 * \hideinitializer
 * \internal
 *
...
/**
 * \brief Flags for the thread ex-regs operation.
 * \ingroup l4_thread_api
 * \hideinitializer
 */
...
l4_thread_stats_time(l4_cap_idx_t thread) L4_NOTHROW
{
  return l4_thread_stats_time_u(thread, l4_utcb());
}
